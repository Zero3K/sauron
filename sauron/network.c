...
Es mant� una llista Protocol/IPOrigen/IPDesti/PortOrigen/PortDesti/NumBytes
Aquesta llista es va buidant al log cada minut

OPCIONAL

Es mant� una llista blanca IP/PORT, es guarda al servidor /var/www/sauron/1/a1/config/NetworkMonitor.conf

Si fa match IP origen/port origen o IP dest�/port dest�, no fer log
Els ports poden ser *
